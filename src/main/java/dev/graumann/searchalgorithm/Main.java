package dev.graumann.searchalgorithm;
...
public class Main extends Application {
    ...
    public void start(Stage primaryStage) throws Exception{
        FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/dev/graumann/searchalgorithm/fxml/Main.fxml"));
        ...
        guiDecorator.setRepositoryURL("https://github.com/BAAMMM1/AI4-IS-P1-Suchen-AStar");

        primaryStage.getIcons().add(new Image(getClass().getResource("/dev/graumann/searchalgorithm/images/icon.png").toExternalForm()));
