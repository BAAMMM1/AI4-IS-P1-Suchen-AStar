...
import model.algorithm.informed.AStar;
import model.algorithm.informed.InformedAlgorithm;
import model.algorithm.informed.heurisitc.DiagonalDistance;
import model.algorithm.informed.heurisitc.EuclideanDistance;
import model.algorithm.informed.heurisitc.Heuristic;
import model.algorithm.informed.heurisitc.ManhattenDistance;
import model.algorithm.uninformed.BreadthFirst;
import model.algorithm.uninformed.DepthFirst;
import model.algorithm.uninformed.UniformCost;
import model.algorithm.uninformed.UninformedAlgorithm;
